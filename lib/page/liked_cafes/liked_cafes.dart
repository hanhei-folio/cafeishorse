...
import 'package:fetching_data/page/liked_cafes/liked_cafes_controller.dart';
...
class LikedCafes extends StatefulWidget {
  @override
  State<LikedCafes> createState() => _LikedCafesState();
}

class _LikedCafesState extends State<LikedCafes> {
  late LikedCafesController controller;

  @override
  void initState() {
    controller = LikedCafesController(context, () => setState(() {}));
    super.initState();
  }
